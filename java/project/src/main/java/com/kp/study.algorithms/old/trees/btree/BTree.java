package com.kp.study.algorithms.old.trees.btree;
...
public class BTree<T> {
    ...
    TreeNode<Integer> buildBinaryTreeFromInAndPreorderTraversal(
            TreeNode<Integer> root, List<Integer> preorderTraversal, List<Integer> inorderTraversal) {
        ...
        if (inorderTraversal == null || inorderTraversal.isEmpty() || preorderTraversal == null
            ...
            List<Integer> rightList =
                    inorderTraversal.subList(inorderTraversal.indexOf(key) + 1, inorderTraversal.size());
